# -*- coding: utf-8 -*-
# aliasfuzz repro | status=alias_diff backend=inductor device=cuda seed=1000114
import torch

def fn(t0, t1, t2, k, lst, dct):
    v1 = t0.view((24,))
    v2 = t0.sum(0, keepdim=False)
    v3 = t1 * 1
    v1[:] += -2
    return (v3, v1, t0, t0, lst, dct)

INPUTS = [('t0', (2, 12)), ('t1', (3, 8)), ('t2', (2, 2, 6))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = True
DEVICE = 'cuda'
