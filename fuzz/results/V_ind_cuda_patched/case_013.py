# -*- coding: utf-8 -*-
# aliasfuzz repro | status=alias_diff backend=inductor device=cuda seed=51000986
import torch

def fn(t0, t1, t2, k, lst, dct):
    idx1 = torch.tensor([1, 0, 2], device=t0.device)
    t0.index_fill_(0, idx1, 1)
    v2 = t0.clone()
    v3 = v2.transpose(1, 0)
    return (t1, t1, v2, t2, t1, lst, dct)

INPUTS = [('t0', (4, 6)), ('t1', (24,)), ('t2', (2, 12))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = True
DEVICE = 'cuda'
