# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=51000597
import torch

def fn(t0, t1, t2, k, lst, dct):
    idx1 = torch.tensor([5], device=t2.device)
    t2.index_fill_(1, idx1, 2)
    v2 = t2 + 2
    v3 = t0.permute(0, 1, 2)
    v4 = t1.unfold(1, 3, 3)
    v4.add_(v4)
    v2.masked_fill_(v2 > 1, 5)
    return (t2, t0, t0, lst, dct)

INPUTS = [('t0', (4, 3, 2)), ('t1', (6, 4)), ('t2', (4, 6))]
ALIASED = None
DTYPE = 'f64'
DYNAMIC = None
DEVICE = 'cuda'
