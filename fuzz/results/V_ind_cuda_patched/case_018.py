# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=51001452
import torch
...
def fn(t0, t1, t2, k, lst, dct):
    ...
    v3 = v2.unfold(2, 3, 4)
    t1.clamp_(-1, 1)
    v4 = t0.unsqueeze(0).expand(3, 2, 3, 4)
    v1.copy_(t2)
    t0.sub_(-4)
    v3.add_(5)
    v5 = t0.view(torch.int32)
    return (v5, v3, v5, v3, lst, dct)

INPUTS = [('t0', (2, 3, 4)), ('t1', (4, 3, 2)), ('t2', (24,))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = None
DEVICE = 'cuda'
