# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=51001281
import torch

def fn(t0, t1, t2, k, lst, dct):
    t1.clamp_(0, 2)
    v1 = t2.unfold(0, 21, 24)
    v2 = v1.transpose(0, 1)
    v3 = t1.unsqueeze(0).expand(2, 4, 3, 2)
    v1.sub_(4)
    return (t1, v1, t1, t1, lst, dct)

INPUTS = [('t0', (2, 2, 6)), ('t1', (4, 3, 2)), ('t2', (24,))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = True
DEVICE = 'cuda'
