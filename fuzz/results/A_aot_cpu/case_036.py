# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=11003911
import torch
...
def fn(t0, t1, t2, k, lst, dct):
    ...
    v1 = t2.transpose(1, 2)
    v2 = v1.unfold(1, 1, 2)
    idx3 = torch.tensor([1, 0], device=v2.device)
    v2.index_fill_(2, idx3, -3)
    v4 = v1.narrow(1, 1, 1)
    v5 = v2.reshape((12,))
    v6 = v1[3::2, 0:1:2, 1:3]
    lst.append(t0)
    return (t1, v1, t1, lst, dct)

INPUTS = [('t0', (24,)), ('t1', (2, 12)), ('t2', (4, 3, 2))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = True
DEVICE = 'cpu'
