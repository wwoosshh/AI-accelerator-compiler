# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=11006914
import torch
...
def fn(t0, t1, t2, ta, k, lst, dct):
    ...
    v3 = t2 * 2
    v4 = v1.unfold(2, 6, 6)
    idx5 = torch.tensor([3, 2, 1], device=v3.device)
    v3.index_copy_(0, idx5, t2.narrow(0, 0, 3))
    v4.fill_(4)
    v2[v2 > 0] = 2
    v6 = v3[:, 4:-1]
    t1[:2, :] = 1
    return (t1, t2, v2, v4, lst, dct)

INPUTS = [('t0', (2, 2, 6)), ('t1', (3, 8)), ('t2', (4, 6))]
ALIASED = ('ta', 't0')
DTYPE = 'f64'
DYNAMIC = None
DEVICE = 'cpu'
