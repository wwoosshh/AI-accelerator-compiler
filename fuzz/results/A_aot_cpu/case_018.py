# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=11002237
import torch

def fn(t0, t1, t2, k, lst, dct):
    idx1 = torch.tensor([9], device=t1.device)
    t1.index_fill_(0, idx1, 5)
    v2 = t1.view((2, 2, 6))
    v3 = v2.unfold(1, 1, 2)
    v3.mul_(0)
    v4 = v2.transpose(2, 1)
    return (v3, v4, v3, t0, lst, dct)

INPUTS = [('t0', (4, 3, 2)), ('t1', (24,)), ('t2', (4, 3, 2))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = True
DEVICE = 'cpu'
