# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=11000234
import torch
...
def fn(t0, t1, ta, k, lst, dct):
    ...
    v1.neg_()
    v2 = ta + v1
    v1.add_(v2.narrow(0, 0, 1))
    t0[:-1] = t0[1:].clone()
    v3 = t1.narrow(0, 0, 1)
    v4 = ta[6:9]
    v5 = v2.view(torch.int32)
    v6 = t1.narrow(0, 1, 1)
    v7 = t1.sum(1, keepdim=False)
    return (v7, v4, v7, t0, v7, lst, dct)
