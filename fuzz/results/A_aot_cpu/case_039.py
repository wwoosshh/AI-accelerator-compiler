# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=11004054
import torch

def fn(t0, t1, t2, k, lst, dct):
    t1.clamp_(-4, 4)
    idx1 = torch.tensor([1, 0], device=t2.device)
    t2[idx1] = 2
    v2 = t1.unfold(0, 2, 3)
    v3 = v2[:, :, 1:]
    v2[-1] = 0
    ...
    v4 = t1.reshape((2, 12))
    v5 = v3.view_as(v3)
    return (v3, v5, v4, v3, lst, dct)

INPUTS = [('t0', (4, 6)), ('t1', (3, 8)), ('t2', (2, 2, 6))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = True
DEVICE = 'cpu'
