# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=11002132
import torch
...
def fn(t0, t1, t2, k, lst, dct):
    ...
    v1.clamp_(0, 2)
    v3 = t1.unfold(1, 1, 3)
    idx4 = torch.tensor([1, 0], device=t1.device)
    t1[idx4] += -4
    v3[v3 > 1] = 2
    v5 = t0.view((2, 3, 4))
    v1[v1 > -1] = k
    return (v2, t1, v1, lst, dct)

INPUTS = [('t0', (2, 2, 6)), ('t1', (2, 3, 4)), ('t2', (3, 8))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = True
DEVICE = 'cpu'
