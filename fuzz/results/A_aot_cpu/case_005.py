# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=11000772
import torch
...
def fn(t0, t1, k, lst, dct):
    ...
    v4 = t1.unfold(2, 1, 2)
    v5 = t0[-1, 8:9]
    idx6 = torch.tensor([1, 0], device=v4.device)
    v4.index_fill_(1, idx6, 0)
    v7 = v4.abs()
    return (t0, v2, lst, dct)
