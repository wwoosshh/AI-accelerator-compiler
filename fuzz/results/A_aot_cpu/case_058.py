# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=11006751
import torch

def fn(t0, t1, t2, ta, k, lst, dct):
    t0.add_(t2.narrow(0, 0, 1))
    v1 = t1.unfold(1, 1, 2)
    v2 = t2.sum(0, keepdim=False)
    lst.append(t2)
    v1[1] = -5
    lst.append(t1)
    v3 = ta[5:21]
    v4 = v2.view_as(v2)
    v5 = v1.squeeze(3)
    return (v5, v2, t0, t0, v5, lst, dct)

INPUTS = [('t0', (24,)), ('t1', (2, 2, 6)), ('t2', (24,))]
ALIASED = ('ta', 't0[1:]')
DTYPE = 'f64'
DYNAMIC = True
DEVICE = 'cpu'
