# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=11008004
import torch
...
def fn(t0, t1, t2, k, lst, dct):
    ...
    v3 = t0 * 2
    v1[:, 1:3, 2:4] = -5
    v4 = torch.minimum(v3, t0)
    v5 = v3.unfold(1, 3, 2)
    v6 = t2.detach()
    return (v4, v3, t0, v4, lst, dct)

INPUTS = [('t0', (6, 4)), ('t1', (24,)), ('t2', (2, 3, 4))]
ALIASED = None
DTYPE = 'f64'
DYNAMIC = None
DEVICE = 'cpu'
