# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=11007735
import torch
...
def fn(t0, t1, t2, k, lst, dct):
    ...
    v3 = v1.transpose(1, 0)
    v4 = v3[2:4:3, 2:3:3]
    idx5 = torch.tensor([3, 2, 1], device=v1.device)
    v1[idx5] = k
    v6 = v3.sum(0, keepdim=False)
    v7 = t0.unfold(0, 8, 9)
    v8 = v4 * 2
    v7[1:, :] = v7[:-1, :].clone()
    return (t1, v7, v1, v4, t1, lst, dct)

INPUTS = [('t0', (24,)), ('t1', (2, 12)), ('t2', (24,))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = None
DEVICE = 'cpu'
