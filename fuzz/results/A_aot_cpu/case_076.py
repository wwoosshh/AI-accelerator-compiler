# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=11008094
import torch
...
def fn(t0, t1, t2, ta, k, lst, dct):
    ...
    v4 = v1.narrow(2, 1, 1)
    v5 = t1.t()
    v6 = v2.sum(0, keepdim=False)
    v5.add_(0)
    return (t2, t1, v6, v5, t1, t2, lst, dct)

INPUTS = [('t0', (4, 6)), ('t1', (2, 12)), ('t2', (6, 4))]
ALIASED = ('ta', 't0')
DTYPE = 'f64'
DYNAMIC = None
DEVICE = 'cpu'
