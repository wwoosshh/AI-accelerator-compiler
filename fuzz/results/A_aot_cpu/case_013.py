# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=11001520
import torch

def fn(t0, t1, t2, k, lst, dct):
    v1 = t1.unfold(2, 3, 4)
    t1[-1] = 1
    v2 = t2.sum(1, keepdim=True)
    v3 = t0[:, :-4:2]
    v4 = v2.unsqueeze(0)
    v3[1] = 3
    v5 = v1.transpose(1, 2)
    v5[1] = -4
    return (v1, v3, t2, v1, lst, dct)

INPUTS = [('t0', (3, 8)), ('t1', (2, 3, 4)), ('t2', (3, 8))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = None
DEVICE = 'cpu'
