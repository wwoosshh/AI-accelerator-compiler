# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=11002401
import torch

def fn(t0, t1, t2, ta, k, lst, dct):
    v1 = ta.unfold(0, 5, 15)
    v2 = t1.view(torch.int32)
    lst.append(t0)
    v3 = v2[:, -1, 7:8:3]
    v1[1] = -3
    v4 = v3[0:, :]
    idx5 = torch.tensor([0, 1], device=v4.device)
    v4[idx5] = 0
    return (v1, v1, t1, lst, dct)

INPUTS = [('t0', (2, 2, 6)), ('t1', (2, 3, 4)), ('t2', (4, 3, 2))]
