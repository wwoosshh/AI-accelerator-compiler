# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=11007821
import torch
...
def fn(t0, t1, t2, k, lst, dct):
    ...
    v3 = v1.to(v1.dtype)
    v4 = v3.unfold(0, 4, 4)
    v4.masked_fill_(v4 > 1, k)
    v5 = v3.view(torch.int32)
    v6 = v4 * 0
    v7 = v2.permute(1, 0)
    return (t0, v7, v5, v4, t0, lst, dct)

INPUTS = [('t0', (4, 3, 2)), ('t1', (6, 4)), ('t2', (24,))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = None
DEVICE = 'cpu'
