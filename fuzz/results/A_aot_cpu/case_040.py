# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=11004073
import torch
...
def fn(t0, t1, t2, k, lst, dct):
    ...
    t2.sub_(3)
    v4 = v3.view_as(v3)
    return (v2, t2, t0, lst, dct)

INPUTS = [('t0', (3, 8)), ('t1', (2, 2, 6)), ('t2', (4, 6))]
ALIASED = None
DTYPE = 'f64'
DYNAMIC = None
DEVICE = 'cpu'
