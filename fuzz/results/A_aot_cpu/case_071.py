# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=11007849
import torch
...
def fn(t0, t1, k, lst, dct):
    ...
    idx4 = torch.tensor([6, 2, 4], device=t0.device)
    t0.index_fill_(1, idx4, k)
    v5 = torch.roll(t1, 2, 1)
    return (t1, v1, t1, t1, lst, dct)
