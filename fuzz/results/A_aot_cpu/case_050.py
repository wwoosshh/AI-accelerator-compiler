# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=11005326
import torch

def fn(t0, t1, t2, k, lst, dct):
    v1 = t0.unfold(1, 9, 9)
    idx2 = torch.tensor([0], device=v1.device)
    v1.index_fill_(0, idx2, 1)
    v3 = t2.view(torch.int32)
    v4 = t2.reshape((4, 3, 2))
    return (v3, v4, t2, t2, lst, dct)

INPUTS = [('t0', (2, 12)), ('t1', (6, 4)), ('t2', (2, 3, 4))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = True
DEVICE = 'cpu'
