# -*- coding: utf-8 -*-
# aliasfuzz repro | status=alias_diff backend=aot_eager device=cpu seed=11004582
import torch
...
def fn(t0, t1, ta, k, lst, dct):
    ...
    v2.index_fill_(0, idx3, k)
    v4 = v2.clone()
    idx5 = torch.tensor([6], device=t0.device)
    t0[idx5] += -3
    return (ta, ta, v1, v4, t1, lst, dct)
