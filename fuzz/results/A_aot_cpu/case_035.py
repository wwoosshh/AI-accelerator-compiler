# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=11003682
import torch
...
def fn(t0, t1, t2, k, lst, dct):
    ...
    v3 = t2.unfold(0, 4, 6)
    v3.sub_(5)
    t2.masked_fill_(v2 > -2, 2)
    v4 = v3.clamp(0, 1)
    idx5 = torch.tensor([3], device=v4.device)
    v4.index_add_(1, idx5, v3.narrow(1, 0, 1))
    return (v3, v1, t1, lst, dct)

INPUTS = [('t0', (4, 6)), ('t1', (24,)), ('t2', (24,))]
ALIASED = None
DTYPE = 'f64'
DYNAMIC = True
DEVICE = 'cpu'
