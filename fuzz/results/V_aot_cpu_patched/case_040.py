# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=41004215
import torch

def fn(t0, t1, t2, k, lst, dct):
    v1 = t0.unfold(2, 3, 6)
    v1.zero_()
    v2 = t0.unsqueeze(0).expand(3, 2, 2, 6)
    v3 = t2.reshape((2, 12))
    t1.masked_fill_(t1 > -1, k)
    v3.fill_(-1)
    v4 = v1[:]
    return (t0, v3, t2, v1, t2, lst, dct)

INPUTS = [('t0', (2, 2, 6)), ('t1', (2, 3, 4)), ('t2', (2, 2, 6))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = True
DEVICE = 'cpu'
