# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=41005547
import torch
...
def fn(t0, t1, ta, k, lst, dct):
    ...
    lst.append(ta)
    t1.fill_(-1)
    v2 = ta.unfold(0, 16, 24)
    idx3 = torch.tensor([0, 9], device=v2.device)
    v2.index_fill_(1, idx3, 4)
    return (t1, t1, v2, ta, t1, lst, dct)

INPUTS = [('t0', (4, 3, 2)), ('t1', (2, 2, 6))]
