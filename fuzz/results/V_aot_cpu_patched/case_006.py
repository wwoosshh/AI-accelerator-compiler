# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=41000929
import torch
...
def fn(t0, t1, k, lst, dct):
    ...
    v1.index_fill_(0, idx3, k)
    idx4 = torch.tensor([20, 23], device=t0.device)
    t0.index_fill_(0, idx4, -3)
    return (t1, t1, t1, t1, lst, dct)
