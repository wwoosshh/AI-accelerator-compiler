# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=41001549
import torch
...
def fn(t0, t1, t2, k, lst, dct):
    ...
    v3.mul_(0)
    v3.sub_(-5)
    v4 = v2.view(torch.int64)
    idx5 = torch.tensor([2, 0, 3], device=v1.device)
    v1.index_fill_(0, idx5, -2)
    return (v4, t0, v2, t1, t1, lst, dct)

INPUTS = [('t0', (2, 12)), ('t1', (3, 8)), ('t2', (6, 4))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = None
DEVICE = 'cpu'
