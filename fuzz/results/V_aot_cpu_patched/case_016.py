# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=41001727
import torch
...
def fn(t0, t1, t2, k, lst, dct):
    ...
    t0[t0 > 2] = 3
    v3 = t1.unsqueeze(2)
    v4 = v3.unsqueeze(0).expand(2, 2, 3, 1, 4)
    return (v2, v4, t1, v4, t0, lst, dct)

INPUTS = [('t0', (2, 2, 6)), ('t1', (2, 3, 4)), ('t2', (4, 6))]
ALIASED = None
DTYPE = 'f64'
DYNAMIC = True
DEVICE = 'cpu'
