# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=41001648
import torch
...
def fn(t0, t1, t2, k, lst, dct):
    ...
    v2 = t1.transpose(1, 0)
    v3 = v1.flatten()
    idx4 = torch.tensor([7, 6, 4], device=v3.device)
    v3.index_fill_(0, idx4, -4)
    v5 = v1[-1, 0:-2, 2, :]
    v6 = v3[9::2]
    v7 = t1.view(torch.int32)
    return (v7, v7, v3, t0, v7, lst, dct)

INPUTS = [('t0', (4, 3, 2)), ('t1', (4, 6)), ('t2', (2, 3, 4))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = None
DEVICE = 'cpu'
