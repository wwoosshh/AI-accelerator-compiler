# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=41005907
import torch
...
def fn(t0, t1, t2, k, lst, dct):
    ...
    v1.index_fill_(2, idx3, -3)
    v4 = v2.unsqueeze(0).expand(2, 4, 3, 1)
    v2.fill_(k)
    v1[2] = k
    return (v4, v1, t1, t1, v4, lst, dct)

INPUTS = [('t0', (2, 12)), ('t1', (4, 6)), ('t2', (4, 3, 2))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = True
DEVICE = 'cpu'
