# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=41006241
import torch
...
def fn(t0, t1, t2, k, lst, dct):
    ...
    lst.append(t1)
    v2 = t0.unfold(2, 1, 3)
    idx3 = torch.tensor([0, 1], device=v2.device)
    v2[idx3] += -3
    v4 = v1.transpose(1, 0)
    v5 = t0.select(0, 1)
    v6 = v5[-2, :]
    return (v6, v6, v2, t0, v6, lst, dct)

INPUTS = [('t0', (2, 3, 4)), ('t1', (3, 8)), ('t2', (24,))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = None
DEVICE = 'cpu'
