# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=41003836
import torch
...
def fn(t0, t1, t2, k, lst, dct):
    ...
    v4 = t2.unfold(2, 6, 5)
    v3[v3 > 0] = 0
    v5 = t1.sum(2, keepdim=True)
    v6 = v2.transpose(1, 2)
    v2.fill_(k)
    v7 = v4.unsqueeze(2)
    v8 = v3.flatten()
    return (v3, v2, v6, t1, lst, dct)

INPUTS = [('t0', (6, 4)), ('t1', (4, 3, 2)), ('t2', (2, 2, 6))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = None
DEVICE = 'cpu'
