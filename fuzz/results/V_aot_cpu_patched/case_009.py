# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=41001478
import torch
...
def fn(t0, t1, ta, k, lst, dct):
    ...
    v2 = t1.abs()
    v2.fill_(-5)
    idx3 = torch.tensor([3], device=v2.device)
    v2.index_add_(1, idx3, t1.narrow(1, 0, 1))
    v4 = t1.unfold(0, 1, 2)
    v4[-1] = -1
    return (t1, ta, v1, t1, lst, dct)
