# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=41004545
import torch
...
def fn(t0, t1, t2, k, lst, dct):
    ...
    v1.index_fill_(1, idx3, 0)
    v4 = v1.clamp(-2, 4)
    return (v4, v2, v4, v4, lst, dct)

INPUTS = [('t0', (6, 4)), ('t1', (6, 4)), ('t2', (2, 12))]
ALIASED = None
DTYPE = 'f64'
DYNAMIC = None
DEVICE = 'cpu'
