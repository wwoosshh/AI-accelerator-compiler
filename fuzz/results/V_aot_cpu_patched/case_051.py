# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=41005934
import torch
...
def fn(t0, t1, t2, k, lst, dct):
    ...
    v2.add_(4)
    t1.sub_(k)
    v3 = torch.slice_scatter(v1, t1[:, :, 5:6:1], dim=2, start=5, end=6, step=1)
    v2.unsqueeze_(3)
    return (v1, v1, v1, v1, lst, dct)

INPUTS = [('t0', (4, 6)), ('t1', (2, 2, 6)), ('t2', (4, 6))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = None
DEVICE = 'cpu'
