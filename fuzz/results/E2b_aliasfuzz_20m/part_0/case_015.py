# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=72001170
import torch
...
def fn(t0, t1, t2, k, lst, dct):
    ...
    v6 = torch.select_scatter(v4, v3.select(1, 0), 1, 0)
    v7 = t0.detach()
    v8 = v1 + 2
    return (v7, v7, t2, lst, dct)

INPUTS = [('t0', (2, 3, 4)), ('t1', (2, 2, 6)), ('t2', (2, 3, 4))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = None
DEVICE = 'cuda'
