# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=72001465
import torch

def fn(t0, t1, t2, k, lst, dct):
    v1 = t0.clone()
    idx2 = torch.tensor([3], device=t0.device)
    t0[idx2] = k
    idx3 = torch.tensor([5], device=v1.device)
    v1.index_copy_(1, idx3, t0.narrow(1, 0, 1))
    return (v1, v1, t1, lst, dct)

INPUTS = [('t0', (4, 6)), ('t1', (2, 2, 6)), ('t2', (2, 2, 6))]
ALIASED = None
DTYPE = 'f64'
DYNAMIC = True
DEVICE = 'cuda'
