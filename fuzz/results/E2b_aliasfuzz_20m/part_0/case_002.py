# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=72000268
import torch
...
def fn(t0, t1, t2, k, lst, dct):
    ...
    v4 = v1.unfold(1, 2, 3)
    v5 = v4.flatten()
    v4.masked_fill_(v4 > 1, 3)
    v6 = torch.ops.aten.alias(t1)
    v7 = v6.contiguous()
    return (v2, v2, t2, lst, dct)

INPUTS = [('t0', (2, 3, 4)), ('t1', (2, 3, 4)), ('t2', (3, 8))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = None
DEVICE = 'cuda'
