# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=72000760
import torch
...
def fn(t0, t1, t2, k, lst, dct):
    ...
    lst.append(t1)
    v3 = v1.unfold(1, 1, 4)
    v4 = t2.view(torch.int32)
    v5 = t1.reshape((6, 4))
    v6 = t0.reshape((4, 6))
    v4.add_(v4)
    v3.fill_(2)
    v7 = v4.contiguous()
    return (t1, v7, v6, v2, t2, t1, lst, dct)

INPUTS = [('t0', (2, 12)), ('t1', (2, 12)), ('t2', (4, 6))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = None
DEVICE = 'cuda'
