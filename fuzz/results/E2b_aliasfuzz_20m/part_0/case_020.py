# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=72001640
import torch

def fn(t0, t1, k, lst, dct):
    v1 = t0.unfold(0, 19, 21)
    v2 = t1.abs()
    v3 = t0.unsqueeze(0).expand(2, 24)
    v4 = t1[2:3, :1]
    v4[:, :] += -4
    v1.add_(-3)
    t1.add_(t1)
