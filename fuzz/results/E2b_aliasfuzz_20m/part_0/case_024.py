# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=72002153
import torch
...
def fn(t0, t1, t2, k, lst, dct):
    ...
    t2.sub_(0)
    v1.mul_(2)
    v2 = torch.diagonal_scatter(t1, t0.diagonal())
    t1.fill_(k)
    v3 = v2.t()
    return (v2, v3, lst, dct)

INPUTS = [('t0', (2, 12)), ('t1', (2, 12)), ('t2', (2, 2, 6))]
ALIASED = None
DTYPE = 'f64'
DYNAMIC = True
DEVICE = 'cuda'
