# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=72002745
import torch
...
def fn(t0, t1, t2, k, lst, dct):
    ...
    v4 = v3.flatten()
    t2.masked_fill_(t2 > -1, 2)
    v5 = v3.view_as(v3)
    return (v4, t0, v4, v3, t1, lst, dct)

INPUTS = [('t0', (2, 12)), ('t1', (2, 12)), ('t2', (3, 8))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = True
DEVICE = 'cuda'
