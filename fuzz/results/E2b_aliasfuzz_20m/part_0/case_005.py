# -*- coding: utf-8 -*-
# aliasfuzz repro | status=alias_diff backend=inductor device=cuda seed=72000547
import torch
...
def fn(t0, t1, k, lst, dct):
    ...
    v2.index_fill_(1, idx4, -5)
    idx5 = torch.tensor([20, 15, 6], device=v3.device)
    v3[idx5] = -3
    v6 = v3[:]
    v7 = v1.flatten()
    return (v6, v3, v6, v6, lst, dct)

INPUTS = [('t0', (3, 8)), ('t1', (2, 3, 4))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = True
DEVICE = 'cuda'
