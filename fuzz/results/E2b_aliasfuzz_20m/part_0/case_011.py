# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=72000932
import torch
...
def fn(t0, t1, t2, ta, k, lst, dct):
    ...
    t1[t1 > -2] = 0
    v2 = v1.abs()
    v3 = ta.sum(0, keepdim=False)
    v4 = t0.unfold(0, 5, 5)
    v5 = t1 * -1
    v4.add_(-4)
    return (t1, t0, v2, lst, dct)

INPUTS = [('t0', (6, 4)), ('t1', (2, 2, 6)), ('t2', (3, 8))]
