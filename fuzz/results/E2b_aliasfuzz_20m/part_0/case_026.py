# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=72002351
import torch
...
def fn(t0, t1, ta, k, lst, dct):
    ...
    v7 = v4.reshape((24,))
    v8 = t0.permute(1, 2, 0)
    ta.masked_fill_(ta > -1, -2)
    return (t0, v2, ta, v7, t1, lst, dct)

INPUTS = [('t0', (4, 3, 2)), ('t1', (2, 12))]
