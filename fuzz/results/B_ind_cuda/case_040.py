# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=21001853
import torch

def fn(t0, t1, t2, ta, k, lst, dct):
    v1 = t0.permute(1, 0)
    ta.masked_fill_(ta > -2, -2)
    v2 = ta.view_as(ta)
    v3 = v2[3, 2:-2]
    v2.add_(v2.flip(1))
    v4 = v2.reshape((24,))
    v5 = v4[10:12]
    v6 = torch.select_scatter(v5, v3.select(0, 0), 0, 0)
    v7 = v3 + 3
    dct['key8'] = v4
    return (v1, v6, lst, dct)

INPUTS = [('t0', (6, 4)), ('t1', (3, 8)), ('t2', (24,))]
