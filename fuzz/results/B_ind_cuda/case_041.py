# -*- coding: utf-8 -*-
# aliasfuzz repro | status=alias_diff backend=inductor device=cuda seed=21001858
import torch
...
def fn(t0, t1, t2, k, lst, dct):
    ...
    v2 = t2[...]
    t2.add_(k)
    v3 = v2.view(torch.int32)
    v4 = t0.view((3, 8))
    v2[-2] = -2
    v5 = v2.permute(1, 0)
    return (t0, v5, t0, v1, t0, lst, dct)

INPUTS = [('t0', (2, 3, 4)), ('t1', (2, 12)), ('t2', (4, 6))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = None
DEVICE = 'cuda'
