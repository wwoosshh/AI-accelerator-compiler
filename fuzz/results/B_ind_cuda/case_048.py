# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=21002175
import torch

def fn(t0, t1, ta, k, lst, dct):
    v1 = t1.unfold(0, 22, 24)
    v2 = t1.reshape((2, 12))
    ...
    v5.add_(v5.flip(0))
    lst.append(v6)
    idx7 = torch.tensor([0], device=v4.device)
    v4.index_fill_(1, idx7, -1)
    return (t1, v6, t1, t0, t1, lst, dct)
