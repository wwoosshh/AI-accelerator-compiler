# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=21000320
import torch

def fn(t0, t1, t2, k, lst, dct):
    v1 = t0.unfold(0, 18, 21)
    v2 = v1.to(v1.dtype)
    ...
    v5 = v4.unsqueeze(0)
    v2.fill_(-2)
    return (v4, t2, t0, t2, v4, lst, dct)

INPUTS = [('t0', (24,)), ('t1', (4, 3, 2)), ('t2', (24,))]
ALIASED = None
DTYPE = 'f64'
DYNAMIC = None
DEVICE = 'cuda'
