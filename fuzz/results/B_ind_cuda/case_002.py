# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=21000126
import torch
...
def fn(t0, t1, k, lst, dct):
    ...
    v3 = t1.unfold(0, 12, 22)
    v4 = v3.permute(1, 0)
    v4.clamp_(-3, 3)
    idx5 = torch.tensor([20, 14, 2], device=v1.device)
    v1[idx5] += k
    return (v4, v1, t0, v3, t0, lst, dct)
