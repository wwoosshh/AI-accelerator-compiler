# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=21001842
import torch

def fn(t0, t1, k, lst, dct):
    t0[3:4:2, :, 0::3] = k
    idx1 = torch.tensor([1, 0], device=t0.device)
    t0.index_fill_(2, idx1, -1)
    t1.add_(k)
    v2 = t1.unsqueeze(0)
    v3 = t1.unfold(0, 9, 19)
    v3.sub_(0)
    v4 = t1.view((1, 24))
    v5 = t1.reshape(t1.shape)
    v6 = t0.unsqueeze(2)
    return (v4, v2, t0, lst, dct)
