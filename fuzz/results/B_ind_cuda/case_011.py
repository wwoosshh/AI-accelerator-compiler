# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=21000574
import torch
...
def fn(t0, t1, t2, ta, k, lst, dct):
    ...
    lst.append(v3)
    v5 = v2.unfold(0, 1, 2)
    idx6 = torch.tensor([0], device=v5.device)
    v5.index_fill_(2, idx6, -1)
    v7 = t1.view((2, 2, 6))
    t1.add_(-5)
    return (v5, t1, v1, t2, lst, dct)

INPUTS = [('t0', (4, 3, 2)), ('t1', (2, 12)), ('t2', (2, 3, 4))]
