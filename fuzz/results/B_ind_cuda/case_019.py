# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=21000962
import torch
...
def fn(t0, t1, t2, ta, k, lst, dct):
    ...
    v1.abs_()
    v3 = v2.flatten()
    v4 = torch.select_scatter(v2, ta.select(0, 7), 0, 7)
    v5 = v3.to(v3.dtype)
    v6 = v5 + t1
    v7 = v1.view(torch.int32)
    return (v2, t1, t1, lst, dct)

INPUTS = [('t0', (2, 12)), ('t1', (24,)), ('t2', (2, 3, 4))]
