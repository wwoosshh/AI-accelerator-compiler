# -*- coding: utf-8 -*-
# aliasfuzz repro | status=alias_diff backend=inductor device=cuda seed=21000983
import torch
...
def fn(t0, t1, ta, k, lst, dct):
    ...
    v2 = ta + k
    v3 = t0.neg()
    v4 = torch.select_scatter(t0, v3.select(0, 4), 0, 4)
    v5 = torch.cat([v2, ta], 0)
    t1.copy_(v2)
    return (v1, v2, t0, lst, dct)
