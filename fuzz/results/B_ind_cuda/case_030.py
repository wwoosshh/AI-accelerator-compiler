# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=21001458
import torch
...
def fn(t0, t1, k, lst, dct):
    ...
    t1.index_fill_(2, idx4, 0)
    v3.sub_(-4)
    v1[:, 2:5, :] = 2
    v5 = t1.unsqueeze(3)
    v6 = v3.view(torch.int64)
    return (t1, v6, lst, dct)

INPUTS = [('t0', (4, 6)), ('t1', (4, 3, 2))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = None
DEVICE = 'cuda'
