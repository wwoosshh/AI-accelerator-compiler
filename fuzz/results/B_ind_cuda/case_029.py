# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=21001429
import torch

def fn(t0, t1, t2, ta, k, lst, dct):
    v1 = t0.permute(0, 1)
    v2 = v1.permute(1, 0)
    idx3 = torch.tensor([3, 1], device=ta.device)
    ta.index_fill_(1, idx3, -3)
    v4 = t2.reshape((4, 3, 2))
    v5 = ta.narrow(0, 1, 2)
    return (t1, v1, v5, t1, lst, dct)
