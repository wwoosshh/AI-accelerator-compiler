# -*- coding: utf-8 -*-
# aliasfuzz repro | status=alias_diff backend=inductor device=cuda seed=21000273
import torch
...
def fn(t0, t1, t2, k, lst, dct):
    ...
    t0.mul_(0)
    v7 = v6.transpose(0, 1)
    v8 = torch.select_scatter(v2, v1.select(2, 1), 2, 1)
    return (v7, v5, v3, lst, dct)

INPUTS = [('t0', (2, 3, 4)), ('t1', (2, 3, 4)), ('t2', (24,))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = None
DEVICE = 'cuda'
