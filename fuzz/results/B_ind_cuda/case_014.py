# -*- coding: utf-8 -*-
# aliasfuzz repro | status=alias_diff backend=inductor device=cuda seed=21000663
import torch
...
def fn(t0, t1, k, lst, dct):
    ...
    v3 = t1 - k
    v4 = v2.unsqueeze(0).expand(3, 2, 2, 6)
    v5 = v1 + -5
    v6 = t0.reshape(t0.shape)
    return (v5, v3, v3, t1, v5, lst, dct)
