# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=21001954
import torch
...
def fn(t0, t1, t2, k, lst, dct):
    ...
    v1 = t2.unfold(0, 2, 2)
    v2 = t2.unfold(0, 2, 3)
    idx3 = torch.tensor([0, 1], device=t1.device)
    t1.index_fill_(0, idx3, 5)
    v2[:, :, 1:2:2] += -3
    v4 = t1.abs()
    return (v1, v4, t2, t2, lst, dct)

INPUTS = [('t0', (6, 4)), ('t1', (4, 6)), ('t2', (3, 8))]
ALIASED = None
DTYPE = 'f64'
DYNAMIC = None
DEVICE = 'cuda'
