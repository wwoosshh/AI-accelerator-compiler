# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=21001302
import torch
...
def fn(t0, t1, ta, k, lst, dct):
    ...
    ta.add_(2)
    v2 = ta.clone()
    idx3 = torch.tensor([3, 1, 0], device=ta.device)
    ta.index_copy_(0, idx3, v2.narrow(0, 0, 3))
    return (ta, v2, t0, t1, lst, dct)

INPUTS = [('t0', (6, 4)), ('t1', (2, 12))]
