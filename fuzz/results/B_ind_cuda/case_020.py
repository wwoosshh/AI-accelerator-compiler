# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=21000972
import torch

def fn(t0, t1, t2, ta, k, lst, dct):
    v1 = t0 - k
    v2 = v1.unfold(0, 17, 17)
    ta[15:19] = k
    v3 = t1.t()
    ...
    v6 = v2.permute(1, 0)
    return (v1, v2, t2, t1, lst, dct)

INPUTS = [('t0', (24,)), ('t1', (6, 4)), ('t2', (2, 3, 4))]
ALIASED = ('ta', 't0[1:]')
DTYPE = 'i64'
DYNAMIC = None
DEVICE = 'cuda'
