# -*- coding: utf-8 -*-
# aliasfuzz repro | status=alias_diff backend=inductor device=cuda seed=21000903
import torch

def fn(t0, t1, ta, k, lst, dct):
    idx1 = torch.tensor([1, 2], device=t0.device)
    t0.index_fill_(0, idx1, -4)
    v2 = ta.t()
    v3 = t0.clone()
    v4 = t1[5:7]
    v5 = v2.flatten()
