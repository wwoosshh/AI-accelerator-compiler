# -*- coding: utf-8 -*-
# aliasfuzz repro | status=alias_diff backend=inductor device=cuda seed=21002120
import torch

def fn(t0, t1, k, lst, dct):
    v1 = t0.flip(1)
    idx2 = torch.tensor([3], device=t1.device)
    t1.index_fill_(0, idx2, -3)
    v3 = t1.clone()
    v1.fill_(5)
    v4 = torch.slice_scatter(v3, t1[1:2:2, :], dim=0, start=1, end=2, step=2)
    return (v1, v3, t0, v1, lst, dct)
