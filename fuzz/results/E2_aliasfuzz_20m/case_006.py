# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=71000429
import torch

def fn(t0, t1, ta, k, lst, dct):
    v1 = torch.maximum(ta, t0)
    t0.copy_(v1)
    v2 = v1.unfold(1, 2, 1)
    ta[1] = -3
    v3 = ta.transpose(1, 2)
    ...
    v6 = v3.narrow(1, 4, 1)
    v7 = v5.reshape((2, 2, 6))
    idx8 = torch.tensor([1], device=v6.device)
    v6.index_fill_(2, idx8, 0)
    return (v4, v3, v4, lst, dct)

INPUTS = [('t0', (2, 2, 6)), ('t1', (2, 3, 4))]
