# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=inductor device=cuda seed=71000476
import torch

def fn(t0, t1, t2, k, lst, dct):
    v1 = torch.ops.aten.alias(t2)
    v2 = torch.select_scatter(t1, t0.select(0, 1), 0, 1)
    v3 = v2.reshape((2, 2, 6))
    t1.zero_()
    v4 = v1[0, :, :]
    return (v4, v2, t1, lst, dct)

INPUTS = [('t0', (6, 4)), ('t1', (6, 4)), ('t2', (2, 2, 6))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = None
DEVICE = 'cuda'
