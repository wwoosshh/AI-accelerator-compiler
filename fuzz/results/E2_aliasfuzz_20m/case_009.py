# -*- coding: utf-8 -*-
# aliasfuzz repro | status=alias_diff backend=inductor device=cuda seed=71000599
import torch

def fn(t0, t1, ta, k, lst, dct):
    v1 = t1.unsqueeze(1)
    t1.masked_fill_(t1 > 2, 0)
    v2 = t1.transpose(1, 0)
    v3 = v1[1, :, 4:-1:3]
    v4 = t1.transpose(1, 0)
    v5 = v2[3:6:3, 2:]
    ...
    ta.clamp_(-2, 1)
    v7 = t0.clone()
    v3.masked_fill_(v3 > 2, 4)
    return (v2, v7, v4, v4, t0, v2, lst, dct)
