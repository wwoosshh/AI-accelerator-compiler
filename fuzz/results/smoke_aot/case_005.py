# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=1000199
import torch
...
def fn(t0, t1, t2, k, lst, dct):
    ...
    v3 = v2.unfold(0, 8, 24)
    v4 = v3[:, 4:6]
    idx5 = torch.tensor([0, 4], device=v3.device)
    v3.index_fill_(1, idx5, -5)
    return (v4, v3, t1, t2, lst, dct)

INPUTS = [('t0', (2, 3, 4)), ('t1', (4, 3, 2)), ('t2', (2, 12))]
ALIASED = None
DTYPE = 'i64'
DYNAMIC = True
DEVICE = 'cpu'
