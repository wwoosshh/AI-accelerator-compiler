# -*- coding: utf-8 -*-
# aliasfuzz repro | status=value_diff backend=aot_eager device=cpu seed=1000177
import torch

def fn(t0, t1, ta, k, lst, dct):
    v1 = ta.flatten()
    v2 = t1.reshape(t1.shape)
    t0.clamp_(0, 3)
    t0.sub_(-3)
    v3 = t0.transpose(2, 0)
    v4 = ta[2::2, 2::3, :]
    ...
    v1[-11] = 2
    ta.sub_(0)
    v6 = v4.unsqueeze(0).expand(2, 1, 1, 2)
    return (ta, v4, t1, lst, dct)
